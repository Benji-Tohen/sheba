...
<?php }?>
	...
	<tr>
		...
		<td><input type="text" name="Subject" value="<?php echo $row_item["Subject"];?>" /></td>		
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			<textarea name="Comments" style="width: 200px; height: 100px;"><?php echo $row_item["Comments"];?></textarea>
		</td>		
	</tr>
	<tr>
		<td><?php echo $text["Enable"];?>:</td>
		<td><input type="checkbox" name="enabled" <?php echo $row_item["enabled"]?"checked":"";?> /></td>		
	</tr>
	<tr>
