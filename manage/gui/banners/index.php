...
if(strcmp($_REQUEST["do"], "duplicate")==0 && $id){

	$content_update->action($id,"duplicate");
}
...
if($bannerType!=0){
	$query.=" AND Banner_Type=".intval($bannerType);
}
  ...
  $(document).ready(function() {
    $("#test-list").sortable({
      ...
      update : function () {		
		...
		$("#info").load("<?php echo $folderName;?>/order_jquery.php?"+order+"&bannerType=<?php echo $bannerType;?>");
...
///classes/thumb/phpThumb.php?zc=1&amp;w=150&amp;h=90&amp;src=../../
				?>
		...
		<div class="itemSap"></div>
                <div class="listItemIcon">
			<a href="index.php?show=<?php echo $folderName;?>/connect&amp;page_id=<?php echo $page_id;?>&amp;id=<?php echo $arr[$i]["ID"];?>&amp;search=<?php echo $_REQUEST["search"];?>"><img border="0" src="images/icons/Links00.png" alt="Connect" /></a>
		</div>
                <div class="itemSap"></div>
                
                <div class="listItemIcon">
			<a href="index.php?show=<?php echo $folderName;?>/index&amp;do=duplicate&amp;page_id=<?php echo $page_id;?>&amp;id=<?php echo $arr[$i]["ID"];?>&amp;search=<?php echo $_REQUEST["search"];?>"><img border="0" src="images/icons/duplicate01.png" alt="Duplicate" /></a>
		</div>
                <div class="itemSap"></div>
