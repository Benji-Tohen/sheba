...
//echo " limit is = LIMIT $start, $limit";
$arr=$db->getArray($query." LIMIT ".$start.", ".$limit);
//echo "query is $query LIMIT $start,$limit";
//print_r($arr);
?>
...
<li id="listItem_<?php echo $arr[$i]["ID"];?>" class="listItem_<?php echo ($i%2==0?0:1);?>">
	...
	<div class="listItemContent">
		...
		<div class="listItemIcon">
		<?php /*<a href="index.php?show=wm_forms_fields/index&amp;form_id=<?php echo $arr[$i]["ID"];?>&amp;search=<?php echo $_REQUEST["search"];?>"><img border="0" src="images/icons/gtk-edit.png" style="height:31px;margin-top:2px;margin-left:4px" alt="Edit" /></a>*/?>
			<a href="index.php?show=wm_forms_fields/index&amp;form_id=<?php echo $arr[$i]["ID"];?>"><img border="0" src="images/icons/gtk-edit.png" style="height:31px;margin-top:2px;margin-left:4px" alt="Edit" /></a>
		</div>
		<div class="itemSap"></div>

		<div class="listItemIcon">
			<a href="index.php?show=wm_forms/duplicate&amp;form_id=<?php echo $arr[$i]["ID"];?>&amp;search=<?php echo $_REQUEST["search"];?>"><img border="0" src="images/icons/duplicate01.png" alt="Duplicate" /></a>
		</div>
		<div class="itemSap"></div>
