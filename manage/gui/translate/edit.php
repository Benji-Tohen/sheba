...
<?php }?>
	...
	<tr>
		...
		<td>
			<select name="Lang">
				<option value="he" <?php echo $row_item["Lang"]=="he"?"selected":"";?>>Hebrew</option>
				<option value="en" <?php echo $row_item["Lang"]=="en"?"selected":"";?>>English</option>
				<option value="ar" <?php echo $row_item["Lang"]=="ar"?"selected":"";?>>Arabic</option>
			</select>
		</td>		
	</tr>
	<tr>
