...
<li id="listItem_<?php echo $arr[$i]["ID"];?>" class="listItem_<?php echo ($i%2==0?0:1);?>">
	...
	<div class="listItemContent">
		...
		<div class="listItemIcon">
			<a href="index.php?show=wm_forms_fields/index&amp;form_id=<?php echo $arr[$i]["ID"];?>&amp;search=<?php echo $_REQUEST["search"];?>"><img border="0" src="images/icons/gtk-edit.png" style="height:31px;margin-top:2px;margin-left:4px" alt="Edit" /></a>
		</div>
		<div class="itemSap"></div>
