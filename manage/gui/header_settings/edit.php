...
*/	
	...
	if(is_uploaded_file($_FILES['File_Name']['tmp_name'])){
		...
		move_uploaded_file($_FILES['File_Name']['tmp_name'], $full_file_path.$file_name);
...
<?php }?>
	...
	<tr>
		...
		<td><input type="text" name="Name" dir="ltr" value="<?php echo $row_item["Name"];?>" /></td>		
	</tr>
	<tr>
		<td valign="top">קובץ:</td>
			<td>
            <input type="file" name="File_Name" dir="ltr" value="<?php echo $row_item["File_Name"];?>" /></td>		
	</tr>
	<tr>
