...
if($_POST){
        ...
        $check_inputs = array(
            array("string255"   => $_POST["twitter_username"]),
            array("string255"   => $_POST["twitter_title"]),
            array("text"        => $_POST["twitter_consumer_key"]),
            array("text"        => $_POST["twitter_consumer_secret"]),
            array("text"        => $_POST["twitter_token"]),
            array("text"        => $_POST["twitter_secret"])
        );
...
<table>		
	<tr>
		<td>שם משתמש בטוויטר:</td>
		<td><input type="text" name="twitter_username" value="<?php echo $row_item["twitter_username"];?>" /></td>		
	</tr>
	<tr>
		<td>שם החשבון:</td>
		<td><input type="text" name="twitter_title" value="<?php echo $row_item["twitter_title"];?>" /></td>		
	</tr>
	<tr>
		<td>Consumer Key:</td>
		<td><input type="text" name="twitter_consumer_key" value="<?php echo $row_item["twitter_consumer_key"];?>" /></td>		
	</tr>
	<tr>
		<td>Consumer Secret:</td>
		<td><input type="text" name="twitter_consumer_secret" value="<?php echo $row_item["twitter_consumer_secret"];?>" /></td>		
	</tr>
	<tr>
		<td>Access Token:</td>
		<td><input type="text" name="twitter_token" value="<?php echo $row_item["twitter_token"];?>" /></td>		
	</tr>
	<tr>
		<td>Access Token Secret:</td>
		<td><input type="text" name="twitter_secret" value="<?php echo $row_item["twitter_secret"];?>" /></td>		
	</tr>
	<tr>
...
<script language="javascript" type="text/javascript">
document.edit.twitter_username.focus();
</script>
