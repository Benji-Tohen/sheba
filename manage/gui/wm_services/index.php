...
$query="SELECT ID, Name, Name_EN, File_Name FROM ".$update_table." WHERE 1";
	...
	<div class="listItemContent">
		...
		<div class="listItemImage">
			<?php if($arr[$i]["File_Name"] && file_exists("../../".$arr[$i]["File_Name"])){?>
				<img src="<?php echo $cfg["WM"]["Server"]."/classes/thumb/phpThumb.php?zc=1&amp;w=150&amp;h=90&amp;src=../../".$arr[$i]["File_Name"];?>" border="1" />
			<?php };?>
		</div>

		<div class="listItemText" dir="<?php echo $gui->getDir();?>">
			<?php echo $arr[$i]["Name"];?><br />
			<?php echo $arr[$i]["Name_EN"];?>
		</div>
