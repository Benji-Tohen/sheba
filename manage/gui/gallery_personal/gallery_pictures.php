...
<table cellspacing="0" class="list_table">
	<tr>
		<td colspan="3"><a href="index.php?show=gallery_personal/gallery_pictures_edit&amp;page_id=<?php echo $page_id;?>"><img border="0" src="images/icons/add.gif" style="cursor: pointer;" alt="Add a Picture" /></a><br />
	  </td>
	</tr>
	<tr>
...
<?php for($i=0;$i<count($arr_pictures);$i++){?>	
	<tr id="list_<?php echo $i;?>" class="list_tr_<?php echo ($i%2==0?0:1);?>">
		...
		<?php }?>		</td>		
		<td valign="top"><a href="index.php?show=gallery_personal/gallery_pictures_edit&amp;page_id=<?php echo $page_id;?>&amp;id=<?php echo $arr_pictures[$i]["ID"];?>"><img border="0" src="images/icons/edit.gif" alt="Edit" /></a></td>
		<td valign="top"><a href="index.php?show=gallery_personal/gallery_pictures&amp;do=del&amp;page_id=<?php echo $page_id;?>&id=<?php echo $arr_pictures[$i]["ID"];?>" onclick="highlight('list_<?php echo $i;?>');return confirm1('list_<?php echo $i;?>', 'list_tr_<?php echo ($i%2==0?0:1);?>', '<?php echo $text["Are you shure you want to delete?"];?>');"><img border="0" src="images/icons/delete.gif" alt="Delete" /></a></td>
	</tr>
<?php }?>
</table>
</div>
