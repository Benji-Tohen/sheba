...
<table>		
	...
	<tr>
		...
		<td><input type="text" name="Name" value="<?php echo $row_picture["Name"];?>" style="width: 300px;" /></td>		
	</tr>
        <tr>
                <td valign="top"><?php echo $text["English Name"];?>:</td>
                <td><textarea name="Value" style="width: 300px; height: auto;"><?php echo $row_picture["Value"];?></textarea></td>		
        </tr>	
	<tr>
