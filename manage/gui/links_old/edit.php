...
if($_POST){
	...
	if(!$_POST["SubmitAdd"]){
		header("location: index.php?show=links/index&page_id=".$page_id);
		exit;
	}else{
		$id=NULL;
	}
...
<a style="color: #ffffff;" href="index.php?show=links/index"><?php echo $text["Links"];?></a> -> <?php echo $row_picture?$row_picture["Name"]:$text["Add Item"];?>
</div>
...
<input type="hidden" name="show" value="links/edit" />
