	...
	<div class="listItemImageContent">
		...
		<div class="listItemImageImage">
			...
			<?php };?>
                ...
                <div style="cursor: pointer;width: 500px;" onclick="changeLayer(this); top.main1.location='index.php?show=<?php echo $folderName;?>/index&Parent_id=<?php echo $arr[$i]["ID"];?>'" class="listItemText" dir="<?php echo $gui->getDir();?>">
			<?php echo $arr[$i]["Name"];?>
		</div>
