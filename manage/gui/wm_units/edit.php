...
<table>
	...
	<tr>
		...
		<td><input type="text" name="Email" value="<?php echo $row_picture["Email"];?>" dir="ltr" /></td>
	</tr>
	<tr>
		<td><?php echo $text["Meta Keywords Units"];?>:</td>
		<td><textarea name="Value"><?php echo $row_picture["Value"];?></textarea></td>
	</tr>
