...
$arrChildren = $wm->getConnectedPages($id,"95","wm_connected_pages_ids.Ordering DESC","0,6"); 
//$arrHomeNewsRelated = $wm->getConnectedPages($id,"103,95,94","wm_connected_pages_ids.Ordering DESC","0,6");
