...
$arrHomeNewsRelated = $wm->getConnectedPages($id,103,"wm_connected_pages_ids.Ordering ASC","0,3");
...
if($homePageEng == '2374' || $wmPage["Lang"]=="en"|| $homePageEng == "42602" || $wmPage["domain"] == "www.sheba.co.il" || $wmPage["domain"] == "heart.sheba.co.il"){
    $isHomePageEng = true;
}else{
    $isHomePageEng = false;
}

$arrChildrenFolder = $wm->getChildren($id,102,"Ordering ASC");/*get general items page under this page that is parent of all children*/
