    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-4 col-lg-3 footerCol">
                <div class="footerTitle"><?php echo $trans->getText("About Us");?></div>
                <div class="richtext">
                    <?php echo $sec["Content"];?>
                </div>
            </div>
            
            <div class="col-12 col-md-4 col-lg-3 offset-lg-2 footerCol">
                <div class="footerTitle"><?php echo $trans->getText("Contact Us");?></div>
            ...
            <div class="col-12 col-md-4 col-lg-3 offset-lg-1 footerCol">
                <div class="footerTitle"><?php echo $trans->getText("Subscribe to your newsletter");?></div>
                
                <div class="footerSubsctibeForm">
                <?php if(isset($_POST["newsletter_Submit"]) && $_POST["newsletter_Submit"]){?>
                    <div class="richtext"><?php echo $trans->getText("thanks for subscribing");?></div>
                    <?php echo $wmPage["Conversion"];?>
                <?php } else { ?>
                    <form id="contactForm" name="contactForm" action="<?php echo $cfg["WM"]["Server"];?>/<?php echo $wmPage["Alias"]?$wmPage["Alias"]:$id;?>/POST" method="post" style="padding: 0px; margin: 0px;" onsubmit="return checkFormContact();">
                        <input type="hidden" name="hidden_url" value="<?php echo $cfg["WM"]["Server"];?>/<?php echo $wmPage["Alias"]?$wmPage["Alias"]:$wmPage["ID"];?>"/>
