        ...
        <div class="col-12 col-md-8 col-lg-8 homeFeed">
            ...
            <div class="row homeChildrenFeed">
                ...
                foreach ($arrChildren as $key => $child) {
                    ...
                    ?>
                <a href="<?php echo $link['Link']?>" target="<?php echo $link['Target']?>" class="col-12 col-md-4 col-lg-4 item newFeedItem">
            ...
            if(is_array($firstBanner)) {
                if($firstBanner['URL']) {?>
                    <a href="<?php echo $firstBanner['URL'];?>" title="<?php echo $firstBanner['Name']; ?>">
                        <img src="<?php echo $thumb_call_banner.$firstBanner['File_Name']?>" alt="<?php echo $firstBanner['Value']?>" title="<?php echo $firstBanner['Value']?>" class="img-fluid bannerImg" />
                    </a>
                <?php } else {?>
                        <img src="<?php echo $thumb_call_banner.$firstBanner['File_Name']?>" alt="<?php echo $firstBanner['Value']?>" title="<?php echo $firstBanner['Value']?>" class="img-fluid bannerImg" />
                <?php }
            ...
            <!-- NEWS FEED -->
            <div class="homeEventsFeed marginbottom " >
                <div class="row">
                    <div class="d-none d-lg-block col-sm-4 col-md-4 col-lg-4">
                        <div class="titleLine bgcolor2"></div>
                    </div>
                    <div class="col-12 col-sm-4 col-md-4 col-lg-4"><h2><?php echo $trans->getText("News");?></h2></div>
                    <div class="d-none d-lg-block col-sm-4 col-md-4 col-lg-4">
                        <div class="titleLine bgcolor2"></div>
                    </div>
                </div>
                ...
                <div class="row carouselWrap">
                    <div class="col-12">
                        <div class="events-slider marginbottom">
                                <?php
                                    ...
                                    ?>
                                        <div>
                                            <a href="<?php echo $link['Link']?>" class="item newFeedItem1">
                                                ...
                                                <img src="<?php echo $thumb_call.$value['Top_Header']?>" alt="<?php echo isset($value['Top_Header_Alt']) ? $value['Top_Header_Alt'] : $value['Name']?>" title="<?php echo isset($value['Name']) ? $value['Name'] : $value['Name']?>" class="newsImg1" />
                ...
                <!-- END Caroufredsel -->
                <?php }?>
                <?php /*<a href="<?php echo $wm->getIdByPageType(104)?>" style="margin-bottom: 60px;" class="moreButton color2"><?php echo $trans->getText("More News");?>&nbsp;&nbsp;<i class="fa fa-chevron-<?php echo $gui->getRight();?> color2"></i></a>*/?>
            ...
            if(is_array($secondBanner)) {
                if($secondBanner['URL']) {?>
                    <a href="<?php echo $secondBanner['URL'];?>" title="<?php echo $secondBanner['Name']; ?>">
                        <img src="<?php echo $thumb_call_banner.$secondBanner['File_Name']?>" alt="<?php echo $secondBanner['Value']?>" title="<?php echo $secondBanner['Value']?>" class="img-fluid bannerImg" />
                    </a>
                <?php } else {?>
                        <img src="<?php echo $thumb_call_banner.$secondBanner['File_Name']?>" alt="<?php echo $secondBanner['Value']?>" title="<?php echo $secondBanner['Value']?>" class="img-fluid bannerImg" />
                <?php }
            ...
            <div class="homeEventsFeed">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-4 col-md-4 col-lg-4"><h2><?php echo $trans->getText("Maternity Club");?></h2></div>
                    <div class="d-none d-lg-block col-sm-4 col-md-4 col-lg-4">
                        <div class="titleLine color2"></div>
                    </div>
                </div>
                                ...
                                <?php
                                    ...
                                    ?>
                                        <div>
                                            <a href="<?php echo $link['Link']?>" class="item newFeedItem1">
                                                <div class="newFeedItemDate"><?php echo $date?></div>
                                                <img src="<?php echo $thumb_call.$value['Top_Header']?>" alt="<?php echo str_replace('"','&quot;', isset($value['Top_Header_Alt']) ? $value['Top_Header_Alt'] : $value['Name'])?>" title="<?php echo str_replace('"','&quot;', isset($value['Name']) ? $value['Name'] : $value['Name'])?>" class="newsImg" />
                                                <h4><?php echo $value['Name']?></h4>
                                                <?php 
                ...
                <?php /*<a href="<?php echo $wm->getIdByPageType(105)?>" style="margin-bottom: 60px;" class="moreButton"><?php echo $trans->getText("More Events");?>&nbsp;&nbsp;<i class="fa fa-chevron-<?php echo $gui->getRight();?> color2"></i></a>*/?>
            </div>
        <?php } ?>
