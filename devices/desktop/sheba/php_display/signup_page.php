<div class="container">
    ...
    <div class="row">
        <div class="col-12 bigImgCont">
            <img src="<?php echo $cfg["WM"]["Server"].'/'.$wmPage["Top_Header2"];?>" class="img-fluid" alt="<?php echo $wmPage["Name"];?>"/>
        </div>
    </div>
    <?php }?>
    ...
    <div class="row">
        <div class="col-12 col-md-5 col-lg-5 formContentDiv">
	...
	<div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-7 offset-lg-1 registerPageContentCenter">
