        ...
        <div class="col-12 col-md-8 col-lg-8 homeFeed">
            ...
            <div class="homeEventsFeed">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-4 col-md-4 col-lg-4"><h2><?php echo $trans->getText("Events Board");?></h2></div>
                    <div class="d-none d-lg-block col-sm-4 col-md-4 col-lg-4">
                        <div class="titleLine color2"></div>
                    </div>
                </div>
            ...
            if(is_array($secondBanner)){
                ?>
                <img src="<?php echo $thumb_call_banner.$secondBanner['File_Name']?>" alt="<?php echo $secondBanner['Value']?>" title="<?php echo $secondBanner['Value']?>" class="img-fluid bannerImg  banneerr" />
            <?php }?>
