...
<div class="row eventsItemsRow" <?php echo !isset($arr[$i])?"style='display: none;'":"";?>>
	...
	<div class="col-12 col-sm-4 col-md-4 col-lg-4 item">
...
//        	            $currentImage='https://sheba.tohendns.com/site/images/defaultNewsPic.jpg';
            ...
            <a href="<?php echo $link["Link"];?>" target="<?php echo $link["Target"];?>" title="<?php echo $arr[$i]["Name"];?>">
                <img src="<?php echo $currentImage;?>" alt="<?php echo $arr[$i]["Name"];?>" title="<?php echo $arr[$i]["Name"];?>" class="img-fluid" />
            </a>
     ...
     $link=$wm->getLink($arr[$i+1]);?>
	   <div class="col-12 col-sm-4 col-md-4 col-lg-4 item">
                ...
                ?>
                    ...
                    <a href="<?php echo $link["Link"];?>" target="<?php echo $link["Target"];?>" title="<?php echo $arr[$i+1]["Name"];?>">
                        <img src="<?php echo $currentImage;?>" alt="<?php echo $arr[$i+1]["Name"];?>" title="<?php echo $arr[$i+1]["Name"];?>" class="img-fluid" />
                    </a>
	   ...
	   <div class="col-12 col-sm-4 col-md-4 col-lg-4 item">
             ...
             <?php if ($arr[$i+2]["Start_Date"]) { 
                ...
                ?>
                    ...
                    <a href="<?php echo $link["Link"];?>" target="<?php echo $link["Target"];?>" title="<?php echo $arr[$i+1]["Name"];?>">
                        <img src="<?php echo $currentImage;?>" alt="<?php echo $arr[$i+2]["Name"];?>" title="<?php echo $arr[$i+2]["Name"];?>" class="img-fluid" />
                    </a>
        ...
        <?php /* if($arr[$i+2]["Top_Header"]){?>
            <a href="<?php echo $link["Link"];?>" target="<?php echo $link["Target"];?>" title="<?php echo $arr[$i+2]["Name"];?>">
                <img src="<?php echo $thumb_call.$arr[$i+2]["Top_Header"];?>" alt="<?php echo $arr[$i+2]["Name"];?>" title="<?php echo $arr[$i+2]["Name"];?>" class="img-fluid" />
            </a>
        <?php }*/?>
