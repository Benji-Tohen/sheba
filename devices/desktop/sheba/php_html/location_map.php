...
<div class="item" id="<?php echo $arr[$i]['Name'];?>">  
<div class="row">
    <!-- ITEM TITLE -->
    <div class="col-9 col-sm-9 col-md-10 col-lg-10 itemText">
        ...
        <h5>
            <i class="fas fa-chevron-<?php echo $gui->getRight();?>"></i><a  href="<?php echo $link["Link"];?>" target="<?php echo $link["Target"];?>" title="<?php echo $arr[$i]["Name"];?>"><?php echo $trans->getText("לעמוד המכון לחץ כאן");?></a>
        </h5>
    </div>
