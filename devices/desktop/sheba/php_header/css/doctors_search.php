...
.doctorSearchPage .richtext{
    ...
    margin-bottom: 18px;
    padding-bottom: 18px;
    border-bottom: 1px solid #d6d6d6;6
}
...
.doctorSearchPage .item:hover .itemText > h3{
    color: #17bd99;
}
...
.doctorSearchPage .item:hover .video-icon{
    background-position: bottom;
}


.searchRow .custom-combobox-input{
    width: 155px;
}

.searchRow .custom-combobox-toggle{
    width: 53px;
}

.searchRow .custom-combobox{
    display:flex;
}
