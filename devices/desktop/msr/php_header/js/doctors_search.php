...
function searchDoctors(){
	...
	if(true){ 
        jQuery.ajax({
            ...
            data: "searchedName="+searchedName+"&searchByMedDomain="+searchByMedDomain+"&searchByUnit="+searchByUnit+"&parentPageId=<?php echo $wmPage['ID']?>",
            async:"true",
            error: function () {
	...
	if(true){ 
        jQuery.ajax({
            ...
            success: function(data){
                ...
                jQuery(selected_letter).css({backgroundColor:"",color:""});
