...
<style type="text/css">
    ...
    .topMenu .navbar-nav > li > a:hover, .topMenu .navbar-nav > li > a:focus{
        ...
        color:  #18a98d;
        border-bottom: 6px solid #18a98d;
    }
    ...
    .popupDialog .closeDialog{
        ...
        top: 0;
        border: none;
        -webkit-border-top-<?php echo $gui->getLeft();?>-radius: 20px;
        -moz-border-radius-top<?php echo $gui->getLeft();?>: 20px;
        border-top-<?php echo $gui->getLeft();?>-radius: 20px;
        -webkit-border-bottom-<?php echo $gui->getRight();?>-radius: 10px;
        -moz-border-radius-bottom<?php echo $gui->getRight();?>: 10px;
        border-bottom-<?php echo $gui->getRight();?>-radius: 10px;
        background-color: #18a98d;
        width: 44px;
        height: 46px;
        text-align: center;
    ...
    .popupDialog .closeDialog:hover, .popupDialog .closeDialog:focus, .popupDialog .closeDialog:active{
    ...
    .navbar-light .hamburger{
        box-shadow: 0 9px 0px 0px #fff, 0px -9px 0px 0px #fff;
        width: 30px;
        height: 2px;
        background: #fff;
...
<script type="text/javascript">
    ...
    function openDialog(title, content){
        if (typeof(title)!=="undefined") $(".popupDialog .dialogTitle").html(title);
        if (typeof(content)!=="undefined") $(".popupDialog .dialogText").html(content);
        $(".popupDialog").toggle();
        $(".overlay").toggle();
    }
    
    var contents = {};      // global object for holding the contents
</script>