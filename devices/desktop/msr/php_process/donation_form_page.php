<?php
    ...
    */
    ...
    if(isset($_POST["hidden_Submit"]) && $_POST["hidden_Submit"]) {      // use $_POST or $_GET
        if(isset($_POST['other_amount']) && !is_numeric($_POST['Amount'])){
            $_POST['Amount'] = $_POST['other_amount'];
        }
    ...
    if($isSent["Success"]){
        ...
        if ((strpos($_SERVER['SERVER_NAME'],"donationhe")!==false) || $wmPage["Lang"] = "he") $params[] = "lang=il";
