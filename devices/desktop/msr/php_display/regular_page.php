    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 <?php if($wmPage["Enable_SideContent"]){?>col-md-8 col-lg-8<?php } else { ?>col-md-12 col-lg-12<?php }?>">
                    ...
                    if(file_exists($arr_pictures[$i]["File_Name"])){
                        ...
                        <div>
                            <a href="<?php echo $link;?>" title="<?php echo $string->htmlentities($arr_pictures[$i]["Name"]);?>" data-gallery>
                                <img src="<?php echo $thumb_call_galleryimage.$arr_pictures[$i]["File_Name"];?>" alt="<?php echo $arr_pictures[$i]["Name"];?>" title="<?php echo $arr_pictures[$i]["Name"];?>" class="img-responsive" />
                            </a>
                        </div>
                <?php }} ?>
            </div>    
            ...
            <?php if($wmPage["wm_forms"]){
				if(strpos($cfg['WM']['Server'],'eng')===false){
					$trueFormPageMsrID = 76082;
				}else{
					$trueFormPageMsrID = 71487;
				}
					?>
			<style type="text/css">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="eventRegisterButton"><a href='<?php echo $cfg["WM"]["Server"]."/item/".$trueFormPageMsrID."/".$wmPage['Page_Type']."/".$wmPage['ID'];?>'><?php echo $wmPage['Form_Btn_Text']?></a></div>
                </div>
            </div>
            <?php } ?>
        </div>
