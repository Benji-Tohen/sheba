	...
	<div class="container">
        <div class="row">
            <div class="row" id="formAnchor">
                ...
                <?php }
                if(($_POST["ConfirmationCode"]=="0000000" && isset($_POST["ConfirmationCode"])) || 
                ...
                <?php }
                    ...
                    foreach ($countries_index as $key=>$rep) {                      // used for exact replace word
                        $wmPage["Content_Center"] = preg_replace('/\b'.$key.'\b/', $rep, $sec["Content_Center"]);
                    }
                ?>
                ...
                <div class="formArea">
                    ...
                    <?php }else{?>
                        ...
                        >
                            ...
                            <div class="row">
                                <div class="col-12 col-md-8 col-lg-8 inputDiv">
