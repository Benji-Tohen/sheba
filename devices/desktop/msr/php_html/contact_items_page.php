...
<div class="row item">  
    <!-- ITEM IMAGE -->
    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 itemImage">
    ...
    <!-- ITEM TITLE -->
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 itemText">
        <a href="<?php echo $link["Link"];?>" target="<?php echo $link["Target"];?>" title="<?php echo $arr[$i]["Name"];?>">
    ...
    <!-- EXPAND -->
    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 itemExpand"  id='<?php echo $arr[$i]['ID']?>'>
