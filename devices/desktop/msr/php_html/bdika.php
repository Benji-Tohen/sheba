<?php
$link=$wm->getLink($arr_connected_institute[$i]);?>
<a href="<?php echo $link["Link"];?>" target="<?php echo $link["Target"];?>" title="<?php echo $arr_connected_institute[$i]["Name"];?>" class="row item">  
    <!-- ITEM ICON -->
    ...
    <div class="col-xs-7 col-sm-9 col-md-9 col-lg-9 itemText">
        ...
        <?php if ($arr_connected_institute[$i]["Sub_Title"]) { ?><h5 class="subTitle"><?php echo nl2br($arr_connected_institute[$i]["Sub_Title"]);?></h5><?php } ?>
