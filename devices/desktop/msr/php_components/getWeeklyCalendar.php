...
<?php if (!$is_param) { ?><div id="weeklyCalendar" class="col-xs-12 col-md-8 col-lg-8"><?php } ?>
    <div class="weeklyHeader">
        <div class="r"><a href="javascript:void(0);" onclick="questAjax('<?php echo $cfg["WM"]["Server"].'/'.$device;?>/php_components/getWeeklyCalendar.php', 't=<?php echo ($prevWeek);?>&Lang=<?php echo $lang;?>', 'weeklyCalendar', 'get', '');"><i class="fa fa-angle-right"></i></a></div>
        <div class="l"><a href="javascript:void(0);" onclick="questAjax('<?php echo $cfg["WM"]["Server"].'/'.$device;?>/php_components/getWeeklyCalendar.php', 't=<?php echo ($nextWeek);?>&Lang=<?php echo $lang;?>', 'weeklyCalendar', 'get', '');"><i class="fa fa-angle-left"></i></a></div>
        <?php//<center>?>
        <div class="center">
            <?php
                echo "אירועים לתאריכים ";
...
#weeklyCalendar .td1 {
    width:14.2%;
    text-align:center;
    border-<?php echo $gui->getRight();?>:1px solid #ffffff;
...
#weeklyCalendar .td2 { 
    ...
    font-size:21px;
    text-align:center;
    border-<?php echo $gui->getRight();?>:1px solid #e2e2e2;
    height:100px;
    position:relative;
}
