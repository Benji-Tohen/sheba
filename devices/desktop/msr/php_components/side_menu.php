...
<div class="sideMenuWrap" id="sideMenu">
    ...
    <div class="sideMenuLogo">
        <?php if($isMesserPage==0){?>
            <img src="<?php echo $cfg["WM"]["Server"];?>/<?php echo $logo["File_Name"];?>" alt="<?php echo $trans->getText("logoName");?>" title="<?php echo $trans->getText("logoName");?>" class="img-responsive" />
        <?php } else {?>
            <?php if($wmPage["Lang"]=="he"){?>
                <img src="<?php echo $cfg["WM"]["Server"];?>/webfiles/languages/1/MESER.png" alt="<?php echo $trans->getText("logoName");?>" title="<?php echo $trans->getText("logoName");?>" class="img-responsive" />
            <?php } else {?>
                <img src="<?php echo $cfg["WM"]["Server"];?>/webfiles/languages/1/MESEREN.png" alt="<?php echo $trans->getText("logoName");?>" title="<?php echo $trans->getText("logoName");?>" class="img-responsive" />
            <?php }?>
        <?php }?>
    </div>
