...
$cachefile = dirname(__FILE__).'/cache/menuCache_'.$_SERVER['HTTP_HOST'].'.html';    
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <?php 
                    ...
                    <li class="dropdown" >
                            ...
                            ?>
                        <a  tabindex="0" target="" <?php echo $target?> class="dropdown-toggle" data-toggle="dropdown"><?php echo $item["Name"];?>
