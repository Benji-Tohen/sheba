...
$newsItemsLimit=$params->getValue("links_page_num_items");
$trans=new Translate($db, $_SESSION["WM"]["Lang"]);

$arr = $wm->getNewsList($id, "Ordering", "LIMIT $start, $newsItemsLimit");

$thumbWidth=$params->getValue("links_page_image_width");
$thumbHeight=$params->getValue("links_page_image_height");
//$thumb_call=$cfg["WM"]["Server"]."/classes/thumb/phpThumb.php?zc=1&amp;w=$thumbWidth&amp;h=$thumbHeight&amp;src=";
$thumb_call=$cfg["WM"]["Server"]."/webfiles/images/cache/".$thumbWidth."X".$thumbHeight."/aoeX1/";
