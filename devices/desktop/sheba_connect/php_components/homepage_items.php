<div class="container">
	<div class="row">
		<div class="col-12 col-sm-8 col-sm-offset-2 offset-md-2 offset-lg-0 col-md-8 col-lg-6">
			...
			<?php } else { ?>
				<img src="<?php echo $thumb_call_inner.$wmPage['Top_Header2'];?>" alt="<?php echo $wmPage['Top_Header2_Alt'];?>" class="img-fluid" />
			<?php }?>
