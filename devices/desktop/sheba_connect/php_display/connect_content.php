...
<div class="page-header-img d-none d-lg-block" style="background-image: url(<?php echo $thumb_inner_img.$wmPage["Top_Header2"];?>)"></div>
<?php }?>

<?php if($wmPage["Top_Header3"]){ ?>
<div class="page-header-img d-block d-lg-none" style="background-image: url(<?php echo $thumb_inner_img_mobile.$wmPage["Top_Header3"];?>)"></div>
<?php }?>
...
<div class="container marg1_b">
	...
	<div class="row">
		<div class="col-12 <?php echo (empty($sideGallery)) ? 'col-md-12 col-lg-12' : 'col-md-8 col-lg-8' ?>">
