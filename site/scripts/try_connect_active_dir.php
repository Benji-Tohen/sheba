...
$ldap_password = 'rhY1310?';
$ldap_username = 'raedha';
/*
Sbxpdc06.sheba.gov.il
Sbxpdc07.sheba.gov.il
*/
$ldap_connection = ldap_connect("ldap://192.168.151.129");

/*$curl = curl_init();
curl_setopt($curl, CURLOPT_URL,"https://wallla.com");

$result = curl_exec($curl);exit;*/


/*print_r(fsockopen("https://sheba.co.il"));
exit;*/
