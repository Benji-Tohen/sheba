...
?>
<a href="#" title="<?php echo $trans->getText("Accessibility")?>" id="toggleBNagish">
...
<div id="BNagishMenu">
	...
	<a href="#" class="webColors" id="BNagish_DefaultColors" title="<?php echo $trans->getText("Normal Display")?>"><?php echo $trans->getText("Normal Display")?></a>
	<a href="#" class="webColors" id="BNagish_Grayscale" title="<?php echo $trans->getText("Turns site to black & white")?>"><?php echo $trans->getText("Adjusted for color blinded")?></a>
	<a href="#" class="webColors" id="BNagish_Inverted" title="<?php echo $trans->getText("Inverts site colors for maximum negativity.  Fit for hard vision")?>"><?php echo $trans->getText("Adjusted for hard vision")?></a>
	<a href="#" id="BNagish_Close" style="background:#34495e;border-radius:0px 0px 7px 7px;color:#f6f6f6;font-size:16px;padding:10px;font-weight:bold;text-align:center" title="<?php echo $trans->getText("Close")?>"><?php echo $trans->getText("Close")?></a>
</div>
